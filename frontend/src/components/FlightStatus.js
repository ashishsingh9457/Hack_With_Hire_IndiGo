  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-#16f330-200">
          <thead className="bg-#06c5de-50">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-#000000-500 uppercase tracking-wider">Flight Number</th>
